                ...
                <div class="mb-4">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 form-group">
                            ...
                            <input class="form-control" name="add1" type="text" placeholder="123 Street">
                        </div>
                        <div class="col-md-6 form-group">
                            <label>Address Line 2</label>
                            <input class="form-control" name="add2" type="text" placeholder="123 Street">
                        </div>
                        <div class="col-md-6 form-group">
                            <label>Country</label>
                ...
                <div class="card border-secondary mb-5">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between mb-3 pt-1">
                            ...
                            <h6 class="font-weight-medium">${{ session()->get('cart')->totalprice }}</h6>
                        </div>
                        <div class="d-flex justify-content-between">
                    ...
                    <div class="card-footer border-secondary bg-transparent">
                        <div class="d-flex justify-content-between mt-2">
                            ...
                            <h5  class="font-weight-bold">${{ session()->get('cart')->totalprice+20 }}</h5>
                            <input type="hidden" name="total" value="{{ session()->get('cart')->totalprice+20 }}" >
                        </div>
                    </div>
                </div>
                <div class="card border-secondary mb-5">
